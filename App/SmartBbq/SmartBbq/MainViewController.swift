...
class MainViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBAction func sendButtonPressed(_ sender: AnyObject) {
        ...
        let wifiNameString=self.WifiName.text
        let wifiPasswordString=self.WifiPassword.text
        let experimentNameString=self.ExperimentName.text
        
        let dataString=wifiNameString!+","+wifiPasswordString!+","+experimentNameString!+","
        let dataToSend = dataString.data(using: String.Encoding.utf8)
